...
class dataLoader(object):
    ...
    def __init__(self, filename, batch_size, opt, evaluation):
        if "dual" in opt["task"]:
            ...
            # ************* Source Data *****************
            source_train_data = f"./datasets/{filename}/train.txt"
            source_valid_data = f"./datasets/{filename}/valid.txt"
            source_test_data = f"./datasets/{filename}/test.txt"
            ...
            target_train_data = f"./datasets/{filename}/train.txt"
            target_valid_data = f"./datasets/{filename}/valid.txt"
            target_test_data = f"./datasets/{filename}/test.txt"
