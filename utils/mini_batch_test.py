...
def test_acc_batch(_test_U2I, _train_U2I, _user_matrix, _item_matrix, topk=20):
    ...
    while batch_id < data_size:
        ...
        hr_out, recall_out, ndcg_out = num_faiss_evaluate({key: _test_U2I[key] for key in batch_users},
                                                          {key: _train_U2I[key] for key in batch_users}, _user_matrix,
                                                          _item_matrix, Topk=topk)
